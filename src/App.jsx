        ...
        <div className="hero-content">
          ...
          >
            <h1>Hi, I'm <span className="highlight">
              <TextType 
                text={["Nathaniel James C. Carrillo", "A Developer"]}
                typingSpeed={100}
                deletingSpeed={50}
                pauseDuration={1500}
                loop={true}
...
<motion.button
  ...
  onClick={async (e) => {
    ...
    link.href = '/CarrilloResume.pdf';
    link.download = 'CarrilloResume.pdf';
    ...
    getResume()
        ...
        >
          <div className="profile-placeholder">
            <img src={ProfileImage} alt="Profile" className="profile-image zoomed-profile"
            style={{ 
              width: '100%', 
              height: '100%', 
              borderRadius: '50%',
            ...
            >
              <div className="about-text-group">
                ...
                <ScrambledText
                  ...
                  scrambleChars=".:"
                >
                  I’m a 3rd-year Computer Science student at Mapúa specializing in Artificial Intelligence. I’m a full-stack developer who enjoys the transition from heavy backend logic to clean, functional interfaces. Whether I’m training NLP models or implementing Computer Vision, my focus is on building complete digital solutions that actually work.
                </ScrambledText>
              </div>
              <ScrambledText
                className="scrambled-text-demo"
                ...
                scrambleChars=".:"
              >
                Outside of academics, I’m usually gaming or keeping pace with emerging technologies. I spend much of my time exploring new frameworks and building from scratch to better understand how modern systems scale. Whether it’s contributing to open-source or diving into a new tech stack, I’m focused on staying versatile and refining my craft alongside the developer community.
              </ScrambledText>
              ...
              {openCategory === 'software' && (
                ...
                >
                  <div className="projects-grid">
                    {[
                      {
                        title: "AI-Powered Secure E-commerce Platform",
                        description: "Built an e-commerce platform with integrated KYC security and automated fraud detection.",
                        tech: ["React", "Node.js", "Express", "MongoDB", "KYC", "AI", "Fraud Detection"],
                        image: EcommerceImage,
                        category: "software",
                        githubUrl: "https://github.com/Semajjang/Graph-Trust",
                        demoUrl: "https://graphtrust.netlify.app/"
                      },
                      {
                        title: "St. Joseph Daycare Enrollment System",
                        description: "A secure enrollment platform for St. Joseph Daycare that digitizes the student onboarding journey for both parents and staff.",
                        tech: ["React", "JavaScript", "CSS", "HTML", "Security"],
                        image: EnrollmentImage,
                        category: "software",
                        githubUrl: "https://github.com/Semajjang/StJoseph-EnrollmentSystem",
                        demoUrl: "https://semajjang.github.io/StJoseph-EnrollmentSystem/"
                      },
                      {
                        ...
                        image: MyAptImage,
                        category: "software",
                        githubUrl: "https://github.com/Semajjang/MyAPT",
                      ...
                      },
                      {
                        ...
                        category: "software",
                        githubUrl: "https://github.com/Semajjang/PetChinGu"
                      }
                    ].map((project, index) => (
                      <motion.div
                        key={index}
                    ...
                    {[
                      {
                        ...
                        category: "ml",
                        githubUrl: "https://colab.research.google.com/drive/1qsknXkwIVfNZNpJfOFHuuxFTVriFTPAx?usp=sharing",
                        paperUrl: "https://docs.google.com/document/d/1ebPPdUOa1kIigPMNj5VT8ZQLbPQN_qA6TuOsBJkDGPc/edit?usp=sharing"
                      },
                      {
                        title: "Automated Pedestrian Accessibility Mapping",
                        description: "An AI framework using Instance Segmentation to map city walkability. It detects sidewalks, ramps, and crosswalks to identify infrastructure gaps and automate urban safety upgrades.",
                        tech: ["Python", "AI", "Instance Segmentation"],
                        image: CompVisionImage,
                        category: "ml",
                        githubUrl: "https://colab.research.google.com/drive/1RRg6EWj9sJE1cdwDcDxZJwAcMcfnaraA?usp=sharing"
                      },
                      {
                        title: "AI-Powered Nutritional Expert for Cats and Dogs",
                        description: "A DeBERTa-powered chatbot that simplifies complex FEDIAF and WALTHAM guidelines. It provides pet owners with instant, science-backed nutritional advice and health insights.",
                        tech: ["Python", "NLP", "DeBERTa", "Chatbot"],
                        image: ChatbotImage,
                        category: "ml",
                        githubUrl: "https://colab.research.google.com/drive/1dJo3UYnU04H7885hWUs_tLhPEl56znxV?usp=sharing",
                        demoUrl: "https://huggingface.co/spaces/johnnydang88/Nutri"
                      }
                    ].map((project, index) => (
                      <motion.div
                        key={index}
          ...
          <div className="contact-content">
            ...
            >
              ...
              <div className="contact-details">
                ...
                >
                  <Mail size={20} />
                  <a href="mailto:njamescarrillo@gmail.com" className="contact-link">
                    njamescarrillo@gmail.com
                  </a>
                </motion.div>
                <motion.div 
                  className="contact-item"
                ...
                >
                  <Phone size={20} />
                  <a href="tel:+639605795072" className="contact-link">
                    +63 960 579 5072
                  </a>
                </motion.div>
                <motion.div 
              ...
              <div className="social-links">
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                  href="https://github.com/semajjang"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <motion.a
                  whileHover={{ scale: 1.1, y: -5 }}
                  whileTap={{ scale: 0.9 }}
                  href="https://www.linkedin.com/in/njcarrillo/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="social-link"
